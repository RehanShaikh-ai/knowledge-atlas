      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 text-text font-semibold text-[14px] mb-1.5 truncate">
            <FileText size={14} className="text-overlay1 shrink-0 inline-block" aria-hidden="true" focusable="false" />
            <span className="truncate">{citation.title}</span>
          </div>
          
          <div className="relative">
            <Quote size={12} className="absolute left-0 top-1 text-overlay2 opacity-50 pointer-events-none" aria-hidden="true" focusable="false" />
